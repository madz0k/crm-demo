            ...
            <ul>
                ...
                <li>
                    <a href="#" className="active">
                        ...
                        <span className="item">Accounts</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span className="icon"><i className="fas fa-tachometer-alt"></i></span>
                        <span className="item">Contracts</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                ...
                <li>
                    <a href="#">
                        ...
                        <span className="item">Incidents</span>
                    </a>
                </li>
            </ul>
        </div>
